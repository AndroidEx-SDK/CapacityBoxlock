...
public class FriendInfoModel implements Parcelable {
    ...
    public FriendInfoModel setFriendId(int friendId) {
    ...
    public FriendInfoModel setFriendNickName(String friendNickName) {
    ...
    public FriendInfoModel setFriendIconUrl(String friendIconUrl) {
    ...
    public FriendInfoModel setDeviceAddress(String deviceAddress) {
    ...
    public FriendInfoModel setIdentificationName(String identificationName) {
    ...
    public FriendInfoModel setJoinTime(String joinTime) {
    ...
    public FriendInfoModel setOnline(boolean online) {
        isOnline = online;
        return this;
    }
    ...
    public FriendInfoModel setBluetoothDevice(BluetoothDevice bluetoothDevice) {
