...
public class BoxStatusActivity extends BaseActivity {
    private final static String TAG = "BoxStatusActivity";
...
//                Toast.makeText(getActivity(), "开锁", Toast.LENGTH_LONG).show();
            ...
            case R.id.tv_boxConfig:
                ...
                BoxDetailActivity.lauch(this, bundle);
                break;
...
//                                        tv_address.setText("携行箱位置未知");
                                ...
                                case Constants.API.API_FAIL:
                                    if (model.info != null) {
                                        CommonKit.showErrorShort(getApplicationContext(), model.info);
                                    }
                                    break;
                                default:
                                    break;
    ...
    public void getBaiduLocation(String latitude, String longitude) {
        ...
        NetApi.getLocation(latitude, longitude, new ResultCallBack<BaiduModel>() {
            ...
            public void onFailure(int statusCode, Request request, Exception e) {
                super.onFailure(statusCode, request, e);
                RLog.e("经纬度转换出错");
                CommonKit.showErrorShort(getApplicationContext(), "网络连接失败");
            }
        });
    }
