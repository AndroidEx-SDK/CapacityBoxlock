...
public class ClipZoomImageView extends ImageView implements
    ...
    public void onGlobalLayout() {
        if (once) {
            ...
            mHorizontalPadding = (getWidth() - clipWidth) / 2;
            ...
            once = false;
            // 计算最小缩放比例
            float minScaleW = clipWidth * 1.0f / dw;
            float minScaleH = clipWidth * 1.0f / dh;
            minScale = Math.max(minScaleH, minScaleW);
        }
